    ...
    public partial class mig_create : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Introductions", x => x.WelcomeID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PopularFlavorsID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PopularFlavors", x => x.PopularFlavorsID);
                });
